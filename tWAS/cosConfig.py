...
AdminConfig.create('JAASAuthData', GlobalSecurityVar, [['userId', 'db2inst1'], ['password', 'db2inst1'], ['description', ''], ['alias', 'gas-twas90Node04/DBUser']])
AdminConfig.save()
...
AdminConfigVar_6=AdminTask.createDatasource(AdminConfigVar_5, ["-componentManagedAuthenticationAlias", "gas-twas90Node04/DBUser" , "-configureResourceProperties", "[[databaseName java.lang.String ORDERDB] [driverType java.lang.Integer 4] [serverName java.lang.String 172.16.52.252] [portNumber java.lang.Integer 50000] ]" , "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper" , "-xaRecoveryAuthAlias", "gas-twas90Node04/DBUser" , "-name", "OrderDS" , "-jndiName", "jdbc/orderds" ])
...
AdminConfigVar_9=AdminTask.createDatasource(AdminConfigVar_5, ["-componentManagedAuthenticationAlias", "gas-twas90Node04/DBUser" , "-configureResourceProperties", "[[databaseName java.lang.String INDB] [driverType java.lang.Integer 4] [serverName java.lang.String 172.16.52.252] [portNumber java.lang.Integer 50000] ]" , "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper" , "-xaRecoveryAuthAlias", "gas-twas90Node04/DBUser" , "-name", "INDS" , "-jndiName", "jdbc/inds" ])
